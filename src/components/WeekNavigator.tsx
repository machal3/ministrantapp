...
import { monday, polishDate, shiftDate } from '../lib/dates';
...
export default function WeekNavigator({ week, onChange }: Props) {
  ...
  return <div className="week-navigator">
    <div className="flex items-center gap-3">
      ...
      {week === monday() && <span className="current-week-label">Bieżący tydzień</span>}
    </div>
    <nav className="week-controls" aria-label="Wybór tygodnia">
      ...
      <button className="today-button" onClick={() => onChange(monday())}>Bieżący</button>
